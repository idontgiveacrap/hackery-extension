...
import { createRegexFieldGroup } from "../lib/regex-field-ui.js";
...
export function wireBuilderFieldUi(fieldElements) {
  ...
  // Initialize Regex Field Groups
  fieldElements.hostPatternGroup = createRegexFieldGroup({
    container: fieldElements.hostPatternCustomContainer,
    editorConfig: { mode: "regex" },
    placeholder: "e.g. \\.example\\.com$",
    regexPlaceholder: "e.g. \\.example\\.com$",
    compact: true,
    onChange: () => {},
  });

  fieldElements.excludePatternGroup = createRegexFieldGroup({
    container: fieldElements.excludePatternCustomContainer,
    editorConfig: { mode: "regex" },
    placeholder: "e.g. /login",
    regexPlaceholder: "e.g. /login",
    compact: true,
    onChange: () => {},
  });

  fieldElements.framesMatchGroup = createRegexFieldGroup({
    container: fieldElements.framesMatchContainer,
    editorConfig: { mode: "regex" },
    placeholder: "e.g. /edit$",
    regexPlaceholder: "e.g. /edit$",
    isMultiline: true,
    onChange: () => {},
  });
}
...
export function readFramesFields(fieldElements) {
  ...
  const patterns = fieldElements.framesMatchGroup.getValue().pattern
    .split(/\r?\n/)
...
export function populateFramesFields(fieldElements, frames) {
  ...
  fieldElements.framesMatchGroup.setValue("regex", Array.isArray(frames.match) ? frames.match.join("\n") : "", "");
  updateFramesFieldVisibility(fieldElements);
}
...
export function clearFramesFields(fieldElements) {
  ...
  fieldElements.framesNestingInput.value = "";
  fieldElements.framesMatchGroup.setValue("plain", "", "");
  updateFramesFieldVisibility(fieldElements);
}
...
export function readHostPattern(fieldElements) {
  ...
  const custom = fieldElements.hostPatternGroup.getValue().pattern;
  if (!custom) {
...
export function populateHostPattern(fieldElements, hostPattern) {
  if (hostPattern === null) {
    ...
    fieldElements.hostPatternGroup.setValue("plain", "", "");
  } else {
    fieldElements.hostPatternModeSelect.value = "custom";
    fieldElements.hostPatternGroup.setValue("regex", hostPattern, "");
  }
  updateHostPatternFieldVisibility(fieldElements);
}
...
export function readExcludePattern(fieldElements) {
  ...
  const custom = fieldElements.excludePatternGroup.getValue().pattern;
  if (!custom) {
...
export function populateExcludePattern(fieldElements, excludePattern) {
  ...
  if (excludePattern === null) {
    ...
    fieldElements.excludePatternGroup.setValue("plain", "", "");
  } else {
    fieldElements.excludePatternModeSelect.value = "custom";
    fieldElements.excludePatternGroup.setValue("regex", excludePattern, "");
  }
  updateExcludePatternFieldVisibility(fieldElements);
}
...
export function getBuilderFieldElements(root = document) {
  return {
    ...
    hostPatternCustomContainer: root.getElementById("host-pattern-custom-container"),
    ...
    excludePatternCustomContainer: root.getElementById("exclude-pattern-custom-container"),
    ...
    framesMatchContainer: root.getElementById("frames-match-container"),
